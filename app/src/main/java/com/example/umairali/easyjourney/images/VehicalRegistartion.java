...
import com.example.umairali.easyjourney.NavBar;
...
public class VehicalRegistartion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vehical_registartion);
        ...
        if (mImageUri!=null){
            ...
            filePath.putFile(mImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    mDatabaseusers.child(user_id).child("Vehical_Image").setValue(downloadUri);
                    mProgress.dismiss();
                    Intent nextIntent=new Intent(VehicalRegistartion.this, NavBar.class);
                    finish();
