...
public class Owner_Cnic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_owner__cnic);
        ...
        if (mImageUri!=null){
            ...
            filePath.putFile(mImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    mDatabaseusers.child(user_id).child("CNIC_Image").setValue(downloadUri);
                    mProgress.dismiss();
                    Intent nextIntent=new Intent(Owner_Cnic.this,Licence.class);
